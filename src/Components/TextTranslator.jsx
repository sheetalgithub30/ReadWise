...
function TextTranslator() {
  ...
  return (
    <div className="border-4 border-purple-800 p-6 mb-3">
<div className="flex justify-end">
    ...
    <div className="flex">   
      ...
      <div className="">
        ...
        <textarea
        className="w-80 h-80 border-4 border-yellow-400 m-2 p-2 outline-none"
        placeholder="Text to be translated" onChange={(e) => setInputValue(e.currentTarget.value)}>
          {inputValue}
        </textarea>
      ...
      <div >
        ...
        <p
         className="w-80 h-80 border-4 border-pink-400 m-2 p-2">{outputValue}</p>
      </div>
    ...
    onClick={getTranslate}>Translate</button>
    </div>
